...
exports.appendShop = async (operation, shop) =>{
    try {
        ...
        shop.stripe_account_id, shop.stripe_price_id, shop.comission, shop.percentage_comission, shop.subscripiton_expiry, shop.tax, shop.stripe_account_enabled, Number(shop.is_tax_percentage)]]);
